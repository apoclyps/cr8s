...
#[get("/crates/<id>")]
pub async fn view_crate(db: DbConn, _user: User, id: i32) -> Result<Value, Custom<Value>> {
    db.run(move |c| {
...
#[delete("/crates/<id>")]
pub async fn delete_crate(db: DbConn, _user: User, id: i32) -> Result<NoContent, Custom<Value>> {
    db.run(move |c| {
